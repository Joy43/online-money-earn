...
document.body.innerHTML = document.body.innerHTML +
    ...
    <div class="vwidget__whenwrapper">
      ...
      <p class="vwidget__verifiedby fs-12" style="justify-content: flex-end;">
...
function setData(item, other) {
    document.getElementsByClassName("vwidget__name")[0].innerHTML = `@${item.username}`;
    document.getElementsByClassName("vwidget__action")[0].innerHTML = `${other[0]} $${item.amount} ${other[1]} ${item.method}`;
